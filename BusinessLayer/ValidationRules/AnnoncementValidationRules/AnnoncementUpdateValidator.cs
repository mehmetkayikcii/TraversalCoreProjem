...
namespace BusinessLayer.ValidationRules.AnnoncementValidationRules
{
    public class AnnoncementUpdateValidator : AbstractValidator<AnnoncementUpdateDto>
    {
        public AnnoncementUpdateValidator()
        {
